  ...
  head: [
    ...
    [
      "meta ",
      {
        name: "keywords",
        content:
          "creative tim, updivision, html dashboard, vue, vuejs, laravel, json:api, json, api, html css dashboard laravel, vue material dashboard laravel, vue material dashboard, material vue admin, vue dashboard, vue admin, web dashboard, bootstrap 4 dashboard laravel, bootstrap 4, css3 dashboard, bootstrap 4 admin laravel, material ui dashboard bootstrap 4 laravel, frontend, responsive bootstrap 4 dashboard, material design, material laravel bootstrap 4 dashboard",
      },
    ],
    [
      "meta ",
      {
        name: "description",
        content:
          "Vue Material Dashboard Laravel helps you build awesome apps with a flexible architecture. It comes with UI components, a Vue Material frontend and an API-powered Laravel backend.",
      },
    ],
    [
      "meta ",
      {
        itemprop: "name",
        content: "Vue Material Dashboard Laravel by Creative Tim & UPDIVISION",
      },
    ],
    [
      "meta ",
    ...
    [
      "meta ",
      {
        itemprop: "image",
        content:
          "https://s3.amazonaws.com/creativetim_bucket/products/331/original/opt_md_vuelaravel_thumbnail.jpg",
      },
    ],
